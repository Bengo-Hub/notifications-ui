...
// notifications-ui never wired the shared app-switcher before — this is its first adoption.
// No [orgSlug] route segment exists here (this app isn't per-tenant URL-scoped), so orgSlug
// comes from the authenticated user's own tenant slug instead of a route param.
...
export function Header({ onMenuClick }: HeaderProps) {
    ...
    const orgSlug = (user as any)?.tenantSlug || 'codevertex';
