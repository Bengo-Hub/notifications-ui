  ...
  return (
    <div className={`border-b px-4 py-2.5 ${colors[variant]}`}>
      <div className="mx-auto flex max-w-6xl items-center gap-3">
        ...
        <Link
          href={actionHref}
          className="inline-flex shrink-0 items-center gap-1 rounded-md border border-current/20 bg-white/20 px-2.5 py-1 text-xs font-medium transition-colors hover:bg-white/40 dark:bg-white/10 dark:hover:bg-white/20"
        >
          {actionLabel}
