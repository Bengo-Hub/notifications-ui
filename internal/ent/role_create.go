...
func (rc *RoleCreate) SetScope(s string) *RoleCreate {
	rc.mutation.SetScope(s)
	return rc
}

// SetNillableScope sets the "scope" field if the given value is not nil.
func (rc *RoleCreate) SetNillableScope(s *string) *RoleCreate {
	if s != nil {
		rc.SetScope(*s)
	}
	return rc
...
func (rc *RoleCreate) SetSystemRole(b bool) *RoleCreate {
	rc.mutation.SetSystemRole(b)
	return rc
}

// SetNillableSystemRole sets the "system_role" field if the given value is not nil.
func (rc *RoleCreate) SetNillableSystemRole(b *bool) *RoleCreate {
	if b != nil {
		rc.SetSystemRole(*b)
	}
	return rc
...
func (rc *RoleCreate) defaults() {
	if _, ok := rc.mutation.Scope(); !ok {
		v := role.DefaultScope
		rc.mutation.SetScope(v)
	}
	if _, ok := rc.mutation.SystemRole(); !ok {
		v := role.DefaultSystemRole
		rc.mutation.SetSystemRole(v)
	}
...
func (rc *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if value, ok := rc.mutation.Scope(); ok {
		_spec.SetField(role.FieldScope, field.TypeString, value)
		_node.Scope = value
	}
	if value, ok := rc.mutation.SystemRole(); ok {
