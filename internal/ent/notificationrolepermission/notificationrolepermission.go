...
const (
	// Label holds the string label denoting the notificationrolepermission type in the database.
	Label = "notification_role_permission"
	...
	// Table holds the table name of the notificationrolepermission in the database.
	Table = "notification_role_permissions"
	// RoleTable is the table that holds the role relation/edge.
	RoleTable = "notification_role_permissions"
	// RoleInverseTable is the table name for the NotificationRole entity.
	// It exists in this package in order to avoid circular dependency with the "notificationrole" package.
	RoleInverseTable = "notification_roles"
	// RoleColumn is the table column denoting the role relation/edge.
	RoleColumn = "role_id"
	// PermissionTable is the table that holds the permission relation/edge.
	PermissionTable = "notification_role_permissions"
	// PermissionInverseTable is the table name for the NotificationPermission entity.
	// It exists in this package in order to avoid circular dependency with the "notificationpermission" package.
	PermissionInverseTable = "notification_permissions"
	// PermissionColumn is the table column denoting the permission relation/edge.
	PermissionColumn = "permission_id"
)

// Columns holds all SQL columns for notificationrolepermission fields.
var Columns = []string{
	FieldID,
	FieldRoleID,
	FieldPermissionID,
...
// OrderOption defines the ordering options for the NotificationRolePermission queries.
