...
func SystemRole(v bool) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldSystemRole, v))
}
...
func SystemRoleEQ(v bool) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldSystemRole, v))
}

// SystemRoleNEQ applies the NEQ predicate on the "system_role" field.
func SystemRoleNEQ(v bool) predicate.Role {
	return predicate.Role(sql.FieldNEQ(FieldSystemRole, v))
}
